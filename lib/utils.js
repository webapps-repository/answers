// /lib/utils.js — FINAL PRODUCTION VERSION (Stable Stage 3)
...
export async function sendEmailHTML({
  ...
  // Critical: must match verified domain
  ...
  try {
    ...
    const out = await client.emails.send({
      from: fromAddress,   // MUST be verified domain
      to,
      subject,
      html,
...
/* ============================================================
   reCAPTCHA VERIFY (safe but bypass-friendly)
============================================================ */
