...
<body style="font-family:system-ui; padding:26px; color:#222; line-height:1.6;">
  ...
  <!-- APPLE-STYLE 14-FIELD COMPARISON TABLE -->
  ${card(`
    <table style="width:100%;border-collapse:collapse;">
      <tr>
        <th style="padding:10px 12px;border-bottom:2px solid #000;text-align:left;"></th>
        <th style="padding:10px 12px;border-bottom:2px solid #000;text-align:left;">
          ${compat1.fullName || "Person 1"}
        </th>
        <th style="padding:10px 12px;border-bottom:2px solid #000;text-align:left;">
          ${compat2.fullName || "Person 2"}
        </th>
      </tr>
  ...
  <p>${comp.overall || comp.overallAdvice || ""}</p>
