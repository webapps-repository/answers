// /lib/insights.js — FINAL FIXED VERSION
// All engines handled via runAllEngines()
...
/* ============================================================
   MAIN INSIGHT ENGINE (Stage-3 unified engine)
============================================================ */
export async function generateInsights({
  ...
  // Stage-3 fully unified engine (palm + numerology + astrology + triad)
  const engines = await runAllEngines({
    question,
    mode,
    uploadedFile: palmImage || null
  });

  return {
    summary: engines.summary || "",
    analysis: engines, // full JSON for PDF & email
    engines,
    fullName,
    birthDate,
    birthTime,
...
/* ============================================================
   PERSONAL EMAIL HTML (legacy wrapper)
============================================================ */
